...
func init() {
	...
	utilruntime.Must(microfrontendv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	// Let the manager observe all namespaces
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "409da382.michalsevcik.dev",
	...
	namespaces := configuration.GetObserveNamespaces()
